...
enum class WeatherGroup: WeatherGroupInterface {
    THUNDER { override val imageRes: Int = R.drawable.ic_thunder },
    DRIZZLE { override val imageRes: Int = R.drawable.ic_rain },
    RAIN { override val imageRes: Int = R.drawable.ic_rain },
    SNOW { override val imageRes: Int = R.drawable.ic_snow },
    ATMOSPHERE { override val imageRes: Int = R.drawable.ic_fog },
    CLEAR { override val imageRes: Int = R.drawable.ic_sun },
    CLOUDS { override val imageRes: Int  = R.drawable.ic_sun_cloudy };
}
